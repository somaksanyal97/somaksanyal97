...
View entire [dissertation](https://github.com/somaksanyal97/dissertationProject_Newcastle/blob/main/Dissertation%20Final.pdf) . <br>
...
• Developed a classification model to detect spam emails using Natural Language Processing (NLP) techniques.
• Trained and evaluated multiple machine learning algorithms, including Naive Bayes, Support Vector Machines, and Random Forest. <br>
